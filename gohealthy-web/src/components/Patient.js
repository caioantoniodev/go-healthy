            ...
            <>
                <Container>
                    ...
                    <Modal show={this.state.modalState} onHide={this.handleClose}>
                        ...
                        <Modal.Footer>
                            <Button variant="primary" type="submit" onClick={this.createPatient}>
                                Salvar
                            </Button>
                        </Modal.Footer>
                    </Modal>
                    ...
                    >
                        ...
                        <Modal.Body>
                            ...
                            <Tab.Container id="list-group-tabs-example" defaultActiveKey="#health-events">
                                <Row>
                                    <Col sm={4}>
                                        <ListGroup>
